# **Historias de Usuario Detalladas - Módulo de Encuesta**
        ...
        **Footer de Tarjeta:**
        ...
        - **Menú de opciones (⋮)** (solo autor de la encuesta):
            ...
            - Dropdown con opciones:
                ...
                - "Editar información" (solo título/descripción, no preguntas)
                - "Cerrar encuesta" (antes del vencimiento)
                - "Eliminar" (solo si no tiene respuestas, confirmación obligatoria)
    - **Estado Vacío:**
...
- **UX-06:** Modal de confirmación de envío:
    ...
    - Ícono de alerta: (naranja `text-warning`)
